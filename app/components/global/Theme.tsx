...
export default function Theme() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className={`dark:bg-primary-bg light-mode-bg dark:text-[#E4E4DC] text-zinc-500 border dark:border-zinc-800 border-zinc-200 rounded-full p-2 duration-300 transition-transform group: ${
